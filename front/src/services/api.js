...
export const getAllArticlesByOneJournalist = async (journalistId) => {
...
export const getAllArticlesByOneCategory = async (categoryId) => {
  const response = await axios.get(
    `${API_BASE_URL}/categories/${categoryId}/articles`
  );
  return response.data;
};
export const getCategoryByOneArticle = async (articleId) => {
  const response = await axios.get(
    `${API_BASE_URL}/articles/${articleId}/categories`
  );
  return response.data;
};
